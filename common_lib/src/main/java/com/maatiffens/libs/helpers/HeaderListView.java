...
public class HeaderListView extends RelativeLayout {
    ...
    public FrameLayout getmScrollView() {
        return mScrollView;
    }
    ...
    public HeaderListViewOnScrollListener headerListViewOnScrollListener = new HeaderListViewOnScrollListener();

    public HeaderListViewOnScrollListener getHeaderListViewOnScrollListener() {
        return headerListViewOnScrollListener;
    }
