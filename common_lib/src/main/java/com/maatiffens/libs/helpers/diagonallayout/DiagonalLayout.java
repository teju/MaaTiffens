package com.maatiffens.libs.helpers.diagonallayout;
...
/**
 * Created by chanpyaeaung on 1/3/18.
 *
...
public class DiagonalLayout extends FrameLayout {
    ...
    public void setDirection(@DiagonalLayoutSettings.Direction int direction) {
