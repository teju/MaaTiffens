...
public class SmartTabLayout extends HorizontalScrollView {
  ...
  private ColorStateList selectedTabViewTextColors;
  ...
  public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    ColorStateList textColors, selectedtextColors;
    ...
    selectedtextColors = a.getColorStateList(
            R.styleable.stl_SmartTabLayout_stl_defaultSelectedTabTextColor);
    ...
    this.selectedTabViewTextColors = (selectedtextColors != null)
            ? selectedtextColors
            : ColorStateList.valueOf(TAB_VIEW_TEXT_COLOR);
    ...
    for (int i = 0; i < adapter.getCount(); i++) {
      ...
      if (i == viewPager.getCurrentItem()) {
        ...
        try {
          ...
          t.setTextColor(selectedTabViewTextColors);
        } catch (Exception e) { }

      }else{
        try {
          TextView t = (TextView) tabView;
          t.setTextColor(tabViewTextColors);
        } catch (Exception e) { }
      }
    ...
    public void onPageSelected(int position) {
      ...
      for (int i = 0, size = tabStrip.getChildCount(); i < size; i++) {
        ...
        if(position == i){
          ...
          tabStrip.getChildAt(i).setSelected(false);
          try {
            TextView t = (TextView) tabStrip.getChildAt(i);
            t.setTextColor(tabViewTextColors);
          } catch (Exception e) { }
